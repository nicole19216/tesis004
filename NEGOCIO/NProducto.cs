...
namespace NEGOCIO
{
    ...
    {
        public static string Insertar(int id_m, int id_u, int id_i, string codigo_barras, string codigo_rapido, string nombre,
            long stock_minimo, long stock_maximo, bool estado, DataTable dtcategoriaproducto,
            DataTable dtdetallecompra, List<byte[]> listimagen)
        {
